...
const translations = {
  es: {
    ...
    'nav.inventory.overview':         'Resumen',
    'nav.inventory.catalog':          'Cat\u00e1logo de Productos',
    'nav.inventory.movements':        'Movimientos',
    'nav.inventory.replenishment':    'Reposici\u00f3n',
    'inv.subtitle':                   'Control de productos, stock y abastecimiento',
    'inv.kpi.active':                 'Productos activos',
    'inv.kpi.lowStock':               'Stock bajo',
    'inv.kpi.outOfStock':             'Sin stock',
    'inv.kpi.movementsToday':         'Movimientos hoy',
    'inv.alerts':                     'Alertas cr\u00edticas',
    'inv.recentMovements':            'Movimientos recientes',
    'inv.table.stock':                'Stock actual',
    'inv.table.reorder':              'Nivel de reorden',
    'inv.status.active':              'Activo',
    'inv.status.lowStock':            'Stock bajo',
    'inv.status.outOfStock':          'Sin stock',
    'inv.type.entry':                 'Entrada',
    'inv.type.sale':                  'Salida venta',
    'inv.type.adjustment':            'Ajuste',
    'inv.type.transfer':              'Traslado',
    'inv.catalog.title':              'Cat\u00e1logo de Productos',
    'inv.catalog.subtitle':           'Gesti\u00f3n de productos del economato penitenciario',
    'inv.table.code':                 'C\u00f3digo',
    'inv.table.product':              'Producto',
    'inv.table.category':             'Categor\u00eda',
    'inv.table.unit':                 'Unidad',
    'inv.table.price':                'Precio venta',
    'inv.table.currentStock':         'Stock actual',
    'inv.table.reorderLevel':         'Reorden',
    'inv.table.actions':              'Acciones',
    'inv.movements.title':            'Movimientos de Inventario',
    'inv.movements.subtitle':         'Historial de entradas, salidas y ajustes',
    'inv.table.movId':                'ID Movimiento',
    'inv.table.datetime':             'Fecha/Hora',
    'inv.table.type':                 'Tipo',
    'inv.table.qty':                  'Cantidad',
    'inv.table.center':               'Centro',
    'inv.table.reference':            'Referencia',
    'inv.rep.title':                  'Reposici\u00f3n de Stock',
    'inv.rep.subtitle':               'Registro de solicitudes de reposici\u00f3n',
    'inv.rep.form.title':             'Nueva solicitud de reposici\u00f3n',
    'inv.rep.product':                'Producto',
    'inv.rep.category':               'Categor\u00eda',
    'inv.rep.center':                 'Centro penitenciario',
    'inv.rep.qty':                    'Cantidad solicitada',
    'inv.rep.supplier':               'Proveedor / fuente',
    'inv.rep.priority':               'Prioridad',
    'inv.rep.expectedDate':           'Fecha esperada',
    'inv.rep.notes':                  'Observaciones',
    'inv.rep.submit':                 'Registrar reposici\u00f3n',
    'inv.rep.suggested':              'Reposiciones sugeridas',
    'inv.rep.pending':                'Solicitudes pendientes',
    'inv.rep.table.id':               'ID',
    'inv.rep.table.product':          'Producto',
    'inv.rep.table.qty':              'Cant.',
    'inv.rep.table.center':           'Centro',
    'inv.rep.table.status':           'Estado',
    'inv.rep.table.date':             'Fecha',
    'inv.priority.high':              'Alta',
    'inv.priority.medium':            'Media',
    'inv.priority.low':               'Baja',
  ...
  en: {
    ...
    'nav.inventory.catalog':          'Product Catalog',
    'nav.inventory.movements':        'Movements',
    'nav.inventory.replenishment':    'Replenishment',
    'inv.subtitle':                   'Product, stock and replenishment control',
    'inv.kpi.active':                 'Active products',
    'inv.kpi.lowStock':               'Low stock',
    'inv.kpi.outOfStock':             'Out of stock',
    'inv.kpi.movementsToday':         'Movements today',
    'inv.alerts':                     'Critical alerts',
    'inv.recentMovements':            'Recent movements',
    'inv.table.stock':                'Current stock',
    'inv.table.reorder':              'Reorder level',
    'inv.status.active':              'Active',
    'inv.status.lowStock':            'Low stock',
    'inv.status.outOfStock':          'Out of stock',
    'inv.type.entry':                 'Entry',
    'inv.type.sale':                  'Sale output',
    'inv.type.adjustment':            'Adjustment',
    'inv.type.transfer':              'Transfer',
    'inv.catalog.title':              'Product Catalog',
    'inv.catalog.subtitle':           'Commissary product management',
    'inv.table.code':                 'Code',
    'inv.table.product':              'Product',
    'inv.table.category':             'Category',
    'inv.table.unit':                 'Unit',
    'inv.table.price':                'Sale price',
    'inv.table.currentStock':         'Current stock',
    'inv.table.reorderLevel':         'Reorder',
    'inv.table.actions':              'Actions',
    'inv.movements.title':            'Inventory Movements',
    'inv.movements.subtitle':         'Entry, output and adjustment history',
    'inv.table.movId':                'Movement ID',
    'inv.table.datetime':             'Date/Time',
    'inv.table.type':                 'Type',
    'inv.table.qty':                  'Qty',
    'inv.table.center':               'Center',
    'inv.table.reference':            'Reference',
    'inv.rep.title':                  'Stock Replenishment',
    'inv.rep.subtitle':               'Replenishment request management',
    'inv.rep.form.title':             'New replenishment request',
    'inv.rep.product':                'Product',
    'inv.rep.category':               'Category',
    'inv.rep.center':                 'Prison center',
    'inv.rep.qty':                    'Requested quantity',
    'inv.rep.supplier':               'Supplier / source',
    'inv.rep.priority':               'Priority',
    'inv.rep.expectedDate':           'Expected date',
    'inv.rep.notes':                  'Notes',
    'inv.rep.submit':                 'Register replenishment',
    'inv.rep.suggested':              'Suggested replenishments',
    'inv.rep.pending':                'Pending requests',
    'inv.rep.table.id':               'ID',
    'inv.rep.table.product':          'Product',
    'inv.rep.table.qty':              'Qty',
    'inv.rep.table.center':           'Center',
    'inv.rep.table.status':           'Status',
    'inv.rep.table.date':             'Date',
    'inv.priority.high':              'High',
    'inv.priority.medium':            'Medium',
    'inv.priority.low':               'Low',
...
const sectionLabels = {
  ...
  'pos-main':                  'nav.pos',
  'inventory-overview':        'nav.inventory.overview',
  'inventory-catalog':         'nav.inventory.catalog',
  'inventory-movements':       'nav.inventory.movements',
  'inventory-replenishment':   'nav.inventory.replenishment',
  'reports':                   'nav.reports',
};
